...
from classification_pipelines import classify_burst_conv_power
...
model_type = "dataset"  # "dataset", "subject"
...
if model_type == "dataset":
    ...
    stratification = "0"    # any "int" that corresponds to a session of the choosen dataset  

if data != "dreyer2023":
    trials_fraction = 0.1
else:
    trials_fraction = 0.05

classification_mode = "incremental"  # "trial", "incremental", "sliding"
